...
export default function title(object: OptionalTitleInterface & OptionalIconInterface): string {
    if (object.getTitle() === null || object.getIcon() === null)
        return '';

    // @ts-ignore
    let _icon = Icons[object.getIcon()]
    return `
