 ...
 */
final class Version20221011150940 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE certification (id INT NOT NULL, user_id INT NOT NULL, title VARCHAR(100) NOT NULL, period_start DATE NOT NULL, period_end DATE DEFAULT NULL, institution VARCHAR(100) NOT NULL, link VARCHAR(500) DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_6C3C6D75A76ED395 ON certification (user_id)');
        $this->addSql('CREATE TABLE education (id INT NOT NULL, user_id INT NOT NULL, title VARCHAR(200) NOT NULL, institution VARCHAR(200) NOT NULL, description TEXT DEFAULT NULL, period_start DATE NOT NULL, period_end DATE DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_DB0A5ED2A76ED395 ON education (user_id)');
        $this->addSql('CREATE TABLE experience (id INT NOT NULL, user_id INT NOT NULL, title VARCHAR(150) NOT NULL, company VARCHAR(50) NOT NULL, description TEXT DEFAULT NULL, period_start DATE NOT NULL, period_end DATE DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_590C103A76ED395 ON experience (user_id)');
        $this->addSql('CREATE TABLE fos_user (id INT NOT NULL, email VARCHAR(200) NOT NULL, first_name VARCHAR(50) DEFAULT NULL, last_name VARCHAR(50) DEFAULT NULL, slug VARCHAR(50) NOT NULL, headline TEXT DEFAULT NULL, role VARCHAR(100) DEFAULT NULL, phone VARCHAR(20) DEFAULT NULL, cell VARCHAR(20) DEFAULT NULL, summary TEXT DEFAULT NULL, country VARCHAR(50) DEFAULT NULL, state VARCHAR(50) DEFAULT NULL, city VARCHAR(50) DEFAULT NULL, gender VARCHAR(6) DEFAULT NULL, birthday DATE DEFAULT NULL, key_words VARCHAR(200) DEFAULT NULL, roles VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, salt VARCHAR(255) DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, is_verified BOOLEAN NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE skill (id INT NOT NULL, user_id INT NOT NULL, name VARCHAR(50) NOT NULL, level_experience SMALLINT NOT NULL, priority SMALLINT DEFAULT NULL, status BOOLEAN NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE user_language (id INT NOT NULL, user_id INT NOT NULL, name VARCHAR(50) NOT NULL, level VARCHAR(50) NOT NULL, PRIMARY KEY(id))');
