...
<head>
	...
	<meta name="description" content="Lilian Vasconcelos, desenvolvedora front-end. Fortaleza-CE">
	<meta name="author" content="lilianvasconcelos">

	<title>Lilian Vasconcelos</title>
...
<body>
	...
	<section id="home" class="tt-fullHeight" data-stellar-vertical-offset="50" data-stellar-background-ratio="0.2">
		<div class="intro">
			<div class="intro-sub">Lilian Vasconcelos</div>
			<h1>Desenvolvedora <span>Fron-End</span></h1>
			<p>Fascinada por desenvolvimento tecnológico, UX designer e Engenharia de Software.</p>

      <div class="social-icons">
        <ul class="list-inline">
          <li><a href="https://www.facebook.com/liliancsvasconcelos" target="_blank"><i class="fa fa-facebook"></i></a></li>
          <li><a href="https://plus.google.com/u/0/109483016031987097064" target="_blank"><i class="fa fa-google-plus"></i></a></li>
          <li><a href="https://www.linkedin.com/in/lilian-vasconcelos-b8276ab2/" target="_blank"><i class="fa fa-linkedin"></i></a></li>
        </ul>
      </div> <!-- /.social-icons -->
		</div>
		...
		<nav class="navbar navbar-custom" role="navigation">
			<div class="container">
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="index.html">Lilian Vasconcelos</a>
				</div>
    ...
    <section id="about" class="about-section section-padding">
      <div class="container">
        <h2 class="section-title wow fadeInUp">Sobre</h2>
        ...
        <div class="row">
          ...
          <div class="col-md-4 col-md-push-8">
            <div class="biography">
              ...
              <ul>
                <li><strong>Nome:</strong> Lilian Vasconcelos</li>
                <li><strong>Nacionalidade:</strong> Brasileira</li>
                <li><strong>E-mail:</strong> contato@lilianvasconcelos.com.br</li>
              </ul>
            </div>
          </div> <!-- col-md-4 -->
          ...
          <div class="col-md-8 col-md-pull-4">
            <div class="short-info wow fadeInUp">
              <h3>Objetivo</h3>
              <p>Expandir e solidificar os conhecimentos adquiridos, sempre buscando a inovação e aplicando-a no trabalho. Aprender novas tecnologias, me fascina, ser desafiada profissionalmente é um estimulo para minha carreira.</p>
            </div>

            <div class="short-info wow fadeInUp">
              <h3>O que eu faço?</h3>
              <p>Trabalho com desenvolvimento front-end,  UX designer, prototipação de telas, designer gráfico. Fazendo especialização em Engenharia de Software, buscando sempre me aprimorar nas tecnologias atuais para realizar um excelente trabalho.</p>
            ...
            <div class="download-button">
              <a class="btn btn-info btn-lg" href="#contact"><i class="fa fa-paper-plane"></i>Enviar-me Mensagem</a>
              <a class="btn btn-primary btn-lg" href="#"><i class="fa fa-download"></i>Download Currículo</a>
            </div>
          </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-12">
              ...
              <a href="#contact" class="btn btn-default">Entre em Contato</a>
            </div><!-- /.col-md-12 -->
          </div><!-- /.row -->
        </div><!-- /.container -->
      </div><!-- /.hire-section-bg -->
                        ...
                        <ul class="timeline">
                                ...
                                <div class="timeline-panel wow fadeInUp">
                                    <div class="timeline-content">
                                        <div class="timeline-heading">
                                            <h3>Especialização em Engenharia de Software</h3>
                                            <span>Estácio, Fortaleza-CE</span>
                                        </div><!-- /timeline-heading -->

                                        <div class="timeline-body">
                                            <p>Especialização em andamento.</p>
                                        </div><!-- /timeline-body -->
                            ...
                            <li class="timeline-inverted">
                                ...
                                <div class="timeline-panel wow fadeInUp">
                                    <div class="timeline-content">
                                        <div class="timeline-heading">
                                            <h3>Tecnóloga em Analise e Desenvolvimento de Sistemas</h3>
                                            <span>Fametro, Fortaleza-CE</span>
                                        </div><!-- /timeline-heading -->

                                        <div class="timeline-body">
                                            <p>Duração de 5 semestres.</p>
                                    </div> <!-- /timeline-content -->
                                </div> <!-- /timeline-panel -->
                            </li>
                                ...
                                <div class="timeline-panel wow fadeInUp">
                                    <div class="timeline-content">
                                        <div class="timeline-heading">
                                            ...
                                            <span>IFCE, Fortaleza-CE</span>
                                        </div><!-- /timeline-heading -->

                                        <div class="timeline-body">
                                            <p>Técnica Integrada em Informática, pelo Instituto Federal.</p>
                                        </div><!-- /timeline-body -->
                                    </div> <!-- /timeline-content -->
                                </div><!-- /timeline-panel -->
                            </li>
                                ...
                                <div class="timeline-panel wow fadeInUp">
                                    <div class="timeline-content">
                                        <div class="timeline-heading">
                                            ...
                                            <span>Mob Telecom</span>
                                        </div><!-- /timeline-heading -->

                                        <div class="timeline-body">
                                            <p>Atualmente trabalho com as tecnologias: Html5, CSS, Javacript, AngularJs, Git, Bootstrap, Bower, Gulp.</p>
                                        </div><!-- /timeline-body -->
                                    </div> <!-- /timeline-content -->
                                </div> <!-- /timeline-panel -->
                            </li>
                            ...
                            <li>
                                ...
                                <div class="timeline-panel wow fadeInUp">
                                    <div class="timeline-content">
                                        <div class="timeline-heading">
                                            <h3>Web Designer</h3>
                                            <span>SAS - Sistema Ari de Sá</span>
                                        </div><!-- /timeline-heading -->

                                        <div class="timeline-body">
                                            <p>Criação de <i>hotsites</i> usando Html5, CSS, Javascript, JQuery e Bootstrap. Manutenção e publicação de conteúdo no portal (Joomla - Criação de menus, artigos e etc.). Criação e divulgação de e-mails marketing utilizando o Joomla.</p>
                                        </div><!-- /timeline-body -->
                                    </div> <!-- /timeline-content -->
                                </div><!-- /timeline-panel -->
                            </li>
                                ...
                                <div class="timeline-panel wow fadeInUp">
                                    <div class="timeline-content">
                                        <div class="timeline-heading">
                                            ...
                                            <span>INB - Instituto Nobre Barreto</span>
                                        </div><!-- /timeline-heading -->

                                        <div class="timeline-body">
                                            <p>Criação de prototipação e layout para sites e fazendo artes gráficas (CorelDraw e Photoshop).</p>
                                        </div><!-- /timeline-body -->
                                    </div> <!-- /timeline-content -->
                                </div> <!-- /timeline-panel -->
                            </li>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="skill-progress">
              <div class="skill-title"><h3>SEO</h3></div> 
              <div class="progress">
          ...
          <div class="col-md-6">
            ...
            <div class="skill-progress">
              <div class="skill-title"><h3>Joomla</h3></div> 
              <div class="progress">
                <div class="progress-bar six-sec-ease-in-out" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" ><span>50%</span>
                </div>
              </div><!-- /.progress -->
    ...
    <section id="works" class="works-section section-padding">
      <div class="container">
        <h2 class="section-title wow fadeInUp">Portfólio</h2>

        <ul class="list-inline" id="filter">
            <li><a class="active" data-group="all">Todos</a></li>
            <li><a data-group="web">Web</a></li>
            <li><a data-group="design">Logos</a></li>
        </ul>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="contact-form">
              <strong>Envie-me uma mensagem:</strong>
              <form name="contact-form" id="contactForm" action="sendemail.php" method="POST">
                ...
                <button type="submit" name="submit" class="btn btn-primary"><i class="fa fa-paper-plane" aria-hidden="true"></i>&nbsp;Enviar Mensagem</button>
              </form>
            </div><!-- /.contact-form -->
          </div><!-- /.col-md-6 -->
        </div><!-- /.row -->
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="copyright text-center">
              <p>2017 &copy; Lilian Vasconcelos</p>
            </div>
          </div>
        </div>
      </div>
